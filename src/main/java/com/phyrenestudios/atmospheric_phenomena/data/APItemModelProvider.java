...
public class APItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        withExistingParent(APBlocks.MOISSANITE_BLOCK.get());
        ...
        basicItem(APItems.MOISSANITE.get());
        ...
        basicItem(APItems.PLATED_SHEET.get());
        basicItem(APItems.STUDDED_SHEET.get());
        basicItem(APItems.EMBOSSED_SHEET.get());
