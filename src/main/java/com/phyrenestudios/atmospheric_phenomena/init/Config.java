...
public class Config {
    ...
    private static final ModConfigSpec.ConfigValue<List<? extends Integer>> OVERWORLD_METEOR_SPAWN_SETTINGS = BUILDER
    ...
    private static final ModConfigSpec.ConfigValue<List<? extends Integer>> OVERWORLD_COMET_SPAWN_SETTINGS = BUILDER
    ...
    private static final ModConfigSpec.BooleanValue METEORITE_DESTROY_ALL = BUILDER
    ...
    private static final ModConfigSpec.DoubleValue METEORITE_CAPSULE_SPAWN_CHANCE = BUILDER
    ...
    private static final ModConfigSpec.DoubleValue SOLID_CORE_METEORITE_CHANCE = BUILDER
            .comment("The chance for a meteorite to generate with no core blocks.")
            .defineInRange("solidCoreMeteoriteChance", 0.2D, 0.0D, 1.0D);
    private static final ModConfigSpec.DoubleValue MAGMA_FREQUENCY = BUILDER
    ...
    private static final ModConfigSpec.DoubleValue STREWN_BLOCK_FREQUENCY = BUILDER
    ...
    private static final ModConfigSpec.ConfigValue<List<? extends Integer>> METEOR_BLOCKS_RARITY = BUILDER
    ...
    private static final ModConfigSpec.ConfigValue<List<? extends Integer>> METEOR_CORE_BLOCKS_RARITY = BUILDER
    ...
    private static final ModConfigSpec.IntValue LIGHTNING_MAX_BLOCKS_CONVERTED = BUILDER
    ...
    private static final ModConfigSpec.DoubleValue BURNING_LOG_SPAWN_FIRE_CHANCE = BUILDER
