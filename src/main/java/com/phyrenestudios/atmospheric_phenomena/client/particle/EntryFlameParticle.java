...
@OnlyIn(Dist.CLIENT)
public class EntryFlameParticle extends TextureSheetParticle {
    private final float flameScale;
    public EntryFlameParticle(ClientLevel level, double x, double y, double z, double vx, double vy, double vz) {
    ...
    public record Factory(SpriteSet sprite) implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            EntryFlameParticle particle = new EntryFlameParticle(level, x, y, z, xSpeed, ySpeed, zSpeed);
