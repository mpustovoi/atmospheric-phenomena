...
public class APChestBoat extends APBoat implements HasCustomInventoryScreen, ContainerEntity {
    ...
    public APChestBoat(EntityType<? extends APBoat> type, Level level) {
        super(type, level);
    }

    public APChestBoat(Level level, double x, double y, double z) {
        this(APEntityTypes.AP_CHEST_BOAT.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
        this.zo = z;
    ...
    public Item getDropItem() {
        return switch (this.getAPBoatType()) {
            case CHARRED -> APItems.CHARRED_CHEST_BOAT.get();
        };
    }
