...
public class APBlocks {
    ...
    public static final RegistryObject<Block> CHARGED_QUARTZ_MATRIX = BLOCKS.register("charged_quartz_matrix", () -> new DropExperienceBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(5.0F, 6.0F), UniformInt.of(5, 10)));
