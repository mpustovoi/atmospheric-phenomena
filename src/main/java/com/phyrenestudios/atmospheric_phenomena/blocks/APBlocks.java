...
public class APBlocks {
    ...
    public static final RegistryObject<Block> KAMACITE = BLOCKS.register("kamacite", () -> new DropExperienceBlock(UniformInt.of(0, 3), BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(5.0F, 6.0F)));
    public static final RegistryObject<Block> TAENITE = BLOCKS.register("taenite", () -> new DropExperienceBlock(UniformInt.of(0, 3), BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(5.0F, 6.0F)));
    public static final RegistryObject<Block> TETRATAENITE = BLOCKS.register("tetrataenite", () -> new DropExperienceBlock(UniformInt.of(0, 3), BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(5.0F, 6.0F)));
    public static final RegistryObject<Block> GOLDEN_MATRIX = BLOCKS.register("golden_matrix", () -> new DropExperienceBlock(UniformInt.of(1, 4), BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(5.0F, 6.0F)));
    public static final RegistryObject<Block> QUARTZ_MATRIX = BLOCKS.register("quartz_matrix", () -> new DropExperienceBlock(UniformInt.of(0, 3), BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(5.0F, 6.0F)));
    ...
    public static final RegistryObject<Block> DEBRIS_MATRIX = BLOCKS.register("debris_matrix", () -> new DropExperienceBlock(UniformInt.of(10, 20), BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(5.0F, 6.0F)));
    public static final RegistryObject<Block> LONSDALEITE_MATRIX = BLOCKS.register("lonsdaleite_matrix", () -> new DropExperienceBlock(UniformInt.of(5, 15), BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(5.0F, 6.0F)));
    ...
    public static final RegistryObject<Block> MOISSANITE_BLOCK = BLOCKS.register("moissanite_block", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(5.0F, 6.0F)));
    ...
    public static final RegistryObject<APWoodenStairBlock> CHARRED_STAIRS = BLOCKS.register(baseName+"_stairs", () -> new APWoodenStairBlock(CHARRED_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(CHARRED_PLANKS.get())));
    ...
    public static final RegistryObject<TrapDoorBlock> CHARRED_TRAPDOOR = BLOCKS.register(baseName+"_trapdoor", () -> new TrapDoorBlock(BlockSetType.OAK, BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BASS).strength(3.0F).noOcclusion().ignitedByLava()));
